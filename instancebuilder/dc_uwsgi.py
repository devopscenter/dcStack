...
class dcUwsgi(ElementBase):
    """Class that installs the nginx code."""

    def __init__(self, argList):
        """Constructor for this class."""
        ElementBase.__init__(self, "uwsgi", argList)
        self.executePath = self.stackDir + "/web/python-uwsgi"
        self.executeScript = "sudo --preserve-env=HOME ./uwsgi.sh "
